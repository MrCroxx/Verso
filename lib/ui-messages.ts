...
export const UI_MESSAGES = {
  "zh-CN": {
    ...
    translationCostHelp: "已有费用保留原值；未记录费用时按当前单价和历史 Token 用量估算，峰谷时段以记录保存时间为准。已计入缓存输入折扣。",
    pricingLabel: "翻译费用 · 币种",
    pricingHelp: "填写单价以估算费用；缓存价留空沿用输入价。更换模型或 API 地址会清空单价。",
    ...
    pricingDeepseekHelp: "填写谷价；北京时间周一至周五 09–12、14–18 时按 2 倍估算，实际以账单为准。",
    ...
    keyboardShortcutsHelp: "按住 ? 或快捷键按钮查看，松开自动隐藏。",
    shortcutGeneral: "通用",
    shortcutReading: "阅读",
    shortcutZoom: "缩放",
    readerZoom: "阅读视图缩放",
    ...
    retry: "重试",
    settings: "设置",
    serverProvider: "AI 服务",
    serverProviderMissing: "配置 AI 服务后即可翻译。",
    provider: "Provider",
    ...
    confirmDiscardBookTranslations: "确认清空",
    discardBookTranslationsHelp: "清空所有语言的译文并停止翻译，无法撤销。",
    cancelDiscardBookTranslations: "取消",
    discardTranslations: "丢弃本书全部译文",
    discardTranslationsHelp: "删除这本书所有目标语言的本地译文缓存，不影响 PDF、目录和页码索引。",
    discardTranslationsConfirm: (name: string) => `清空《${name}》所有语言的译文并停止翻译？无法撤销。`,
  ...
  "en-US": {
    ...
    translationCostHelp: "Recorded costs are preserved. Unpriced history is estimated from saved tokens and current prices, using the record's save time for peak periods. Cached input pricing is applied.",
    pricingLabel: "Translation cost · Currency",
    pricingHelp: "Set prices to estimate costs. A blank cache price uses the input price. Changing the model or endpoint clears prices.",
    ...
    pricingDeepseekHelp: "Enter off-peak prices. Estimates double Mon–Fri, 09:00–12:00 and 14:00–18:00 (UTC+8). Actual charges follow the provider bill.",
    ...
    keyboardShortcutsHelp: "Hold ? or the shortcuts button to view. Release to hide.",
    shortcutGeneral: "General",
    shortcutReading: "Reading",
    shortcutZoom: "Zoom",
    ...
    retry: "Retry",
    settings: "Settings",
    serverProvider: "AI provider",
    serverProviderMissing: "Configure an AI provider to start translating.",
    provider: "Provider",
    openaiProvider: "OpenAI",
    compatibleProvider: "OpenAI Compatible",
    apiEndpoint: "API Endpoint",
    ...
    apiKeyHelp: "Leave blank to keep the current key.",
    model: "Model",
    reasoningEffort: "Reasoning effort",
    ...
    confirmDiscardBookTranslations: "Confirm deletion",
    discardBookTranslationsHelp: "Delete translations in all languages and stop translation. Cannot be undone.",
    ...
    discardTranslationsConfirm: (name: string) => `Delete translations in all languages for “${name}” and stop translation? Cannot be undone.`,
    ...
    offsetHelp: "Printed page + offset = PDF page.",
