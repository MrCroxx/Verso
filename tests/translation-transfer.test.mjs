...
test('translation transfer downloads archives and refreshes imported pages in the desktop reader', {
  timeout: 90_000,
  ...
  const directory = await mkdtemp(path.join(tmpdir(), 'verso-translation-transfer-'));
